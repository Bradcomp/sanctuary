  ...
  describe('Applicative', function() {
    ...
    it('satisfies identity', function() {
      forall(EitherArb(jsc.constant(null), jsc.constant(null)),
             EitherArb(jsc.string, jsc.integer),
             function(a, v) {
               var lhs = v[FL.ap](S.of(a.constructor, S.I));
               var rhs = v;
               return Z.equals(lhs, rhs);
             });
    });
    ...
    it('satisfies homomorphism', function() {
      ...
      forall(EitherArb(jsc.constant(null), jsc.constant(null)),
             jsc.integer,
             function(a, x) {
               var lhs = S.of(a.constructor, x)[FL.ap](S.of(a.constructor, f));
    ...
    it('satisfies interchange', function() {
      forall(EitherArb(jsc.constant(null), jsc.constant(null)),
             ...
             jsc.integer,
             function(a, u, x) {
               var lhs = S.of(a.constructor, x)[FL.ap](u);
               var rhs = u[FL.ap](S.of(a.constructor, S.T(x)));
               return Z.equals(lhs, rhs);
             });
    });
  ...
  describe('Monad', function() {
    ...
    it('satisfies left identity', function() {
      ...
      forall(EitherArb(jsc.constant(null), jsc.constant(null)),
             jsc.integer,
             function(m, x) {
               var lhs = S.of(m.constructor, x)[FL.chain](f);
               var rhs = f(x);
               return Z.equals(lhs, rhs);
             });
    });
    ...
    it('satisfies right identity', function() {
      forall(EitherArb(jsc.string, jsc.integer),
             function(m) {
               var lhs = m[FL.chain](S.of(m.constructor));
               var rhs = m;
               return Z.equals(lhs, rhs);
             });
    });
